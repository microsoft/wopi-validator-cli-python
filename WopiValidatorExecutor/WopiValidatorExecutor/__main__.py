...
def main():
    ...
    parser.add_argument('-c', type=str, default=defaultTestCategory, help="Defines the target TestCategory, It could either be All, OfficeOnline or OfficeNativeClient and is case-insensitive.")
    parser.add_argument('-s', type=str, default=defaultWopiDiscoveryServiceUrl, help="This represents the WOPI Discovery Service Url for OfficeOnline.")
    parser.add_argument('-v', action="store_const", dest='logLevel', const=logging.DEBUG, default=logging.WARNING, help="Turns on verbose logging")
    args = parser.parse_args()

    # Initialize logging.
    logging.basicConfig(format=EXECUTOR_LOGFORMAT, datefmt=EXECUTOR_DATEFORMAT, filename=EXECUTOR_LOGFILE_NAME, filemode='w', level=args.logLevel)
    ...
    from WopiValidatorExecutor.WopiValidatorExecutor import ExecuteWopiValidator
